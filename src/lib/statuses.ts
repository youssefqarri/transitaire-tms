...
export const STATUS_LABELS: Record<DossierStatus, string> = {
  ...
  MAIN_LEVEE_RESERVE_CONFORMITE: "Mainlevée — réserve conformité",
  MAIN_LEVEE_RESERVE_DOCUMENTS: "Mainlevée — réserve documents",
...
export const DOCUMENT_CATEGORY_LABELS: Record<DocumentCategory, string> = {
  ...
  BON_A_ENLEVER: "Bon à enlever",
  MAIN_LEVEE_RESERVE_PAIEMENT: "Mainlevée sous réserve paiement",
