...
export function TooltipProvider() {
  ...
  return createPortal(
    <div
      ...
      className="px-2 py-1 rounded-[var(--radius-sm)] bg-[var(--color-fg)] text-[var(--color-surface)] text-[11.5px] font-medium leading-snug shadow-[0_6px_20px_-6px_rgba(0,0,0,0.35)] max-w-[260px] text-center"
    >
      {tip.text}
    </div>,
    document.body,
